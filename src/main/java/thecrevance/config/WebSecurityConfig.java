...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf()
                ...
                .antMatchers(HttpMethod.GET, "/v1/banks").permitAll()
                .antMatchers(HttpMethod.PUT, "/v1/users/update-info").authenticated()
                .antMatchers(HttpMethod.PUT, "/v1/users/bank-details").authenticated()
